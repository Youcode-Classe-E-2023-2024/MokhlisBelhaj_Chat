    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
        ...
        <div class="flex flex-col flex-auto h-full p-6">
            <div class="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
                ...
                <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
    <form id="messageForm" class="flex-grow ml-4">
        <div class="relative w-full">
            <input type="text" name="messageInput" class="flex w-full border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10" />
            <button type="submit" class="absolute flex items-center justify-center h-full w-12 right-0 top-0 text-gray-400 hover:text-gray-600">
                <!-- You can add an icon or content inside the button if needed -->
            </button>
        </div>
    </form>
    <div class="ml-4">
